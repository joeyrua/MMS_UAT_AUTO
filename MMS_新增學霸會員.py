...
time.sleep(2)
wait.until(lambda driver:driver.find_element("xpath","/html/body/div/div[2]/main/div[2]/div[1]/div/div"))
member_type = URL.find_element("xpath","/html/body/div/div[2]/main/div[2]/div[1]/div/div")
member_type.click()#會員類型

wait.until(lambda driver:driver.find_element("xpath","/html/body/div[2]/div[3]/ul/li[2]"))
choose_bar = URL.find_element("xpath","/html/body/div[2]/div[3]/ul/li[2]")
choose_bar.click()
#選擇學霸
...
input_onclub_id.send_keys("baruat003")#輸入oneclub_id:baruat003
...
input_student1.send_keys("✖王小氣")#輸入學生姓名
