...
input_oneclub_id.send_keys("pink002")#輸入學生Oneclub_id
...
start_time.send_keys(Keys.CONTROL, 'v ')#輸入課程開始時間(請先複製時間 ex:1600)
...
choose_teacher.send_keys("黃一一")#輸入老師(如果，要使用已排課老師，請先到教師列表排課)
